...
class TeamLeaderServiceImplTest {
	...
	@Test
	void test_Register_TeamLeader_Given_TeamLeader_Should_Save_TeamLeader_And_Return() {
	...
	@Test
	void test_FindTeamLeaderByLoginName_Given_LoginName_Should_Return_TeamLeader() {
	...
	@Test
	void test_FindTeamLeaderByLoginName_Given_LoginName_Should_Throw_TeamLeaderNotFoundException() {
		TeamLeader teamLeader = new TeamLeader();
	...
	@Test
	void test_UpdateTeamLeader_Given_No_LoginName_In_TeamLeader_Should_Throw_NullPointerExceptionException() {
		TeamLeader teamLeader = new TeamLeader();
		teamLeader.setName("Test");
		teamLeader.setPwd("test123");
	...
	@Test
	void test_UpdateTeamLeader_Given_TeamLeader_Should_Be_Updated_And_Return_UpdatedTeamLeader() {
	...
	@Test
	void test_viewAllRemarkGiven_TaskIdentifier_Should_Return_AllRemarks_In_The_task() {
	...
	@Test
	void test_viewAllRemarkGiven_WrongTaskIdentifier_ShouldThrow_TaskNotFoundException() {
	...
	@Test
	void test_viewAllDevelopers_Should_Return_List_Of_Developers() {
	...
	@Test
	void test_viewAllDevelopers_ShouldThrow_DeveloperNotFoundException() {
	...
	@Test
	void test_assignTaskToDeveloper_GivenTask_AssignToDeveloper() {
	...
	@Test
	void test_assignTaskToDeveloper_GivenDeveloper_ShouldThrowDeveloperIdException() {
		BDDMockito.given(developerRepository.findByLoginName("Test123")).willReturn(null);
		BDDMockito.given(taskRepository.findByTaskIdentifier(taskId)).willReturn(task);
		BDDMockito.given(taskRepository.save(task)).willReturn(task);
		BDDMockito.given(developerRepository.save(developer)).willReturn(developer);
		Exception ex = assertThrows(DeveloperIdException.class,
	...
	@Test
	void test_assignTaskToDeveloper_GivenTask_ShouldThrowTaskIdException() {
		BDDMockito.given(developerRepository.findByLoginName(developerLoginName)).willReturn(developer);
